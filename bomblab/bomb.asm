...
0000000000400efc <phase_2>:
  ...
  400f02:	48 89 e6             	mov    %rsp,%rsi                    # oldTop
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                  # ($rsp) = 1 will not explode
  400f0e:	74 20                	je     400f30 <phase_2+0x34>        # 400f30
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>        # 400f30
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax              # %eax = M[(%rbx) - 4]
  400f1a:	01 c0                	add    %eax,%eax                    # %eax *= 2
  400f1c:	39 03                	cmp    %eax,(%rbx)                  
  400f1e:	74 05                	je     400f25 <phase_2+0x29>        # M(%rbx) = M[(%rbx) - 4] * 2
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx                    # move the iterator
  400f29:	48 39 eb             	cmp    %rbp,%rbx                    # reach the end
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>        
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx               # loop init
...
0000000000400f43 <phase_3>:
  ...
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>    # R[%eax] > 1 will not explode
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>    # M[R[%rsp] + 8] > 7
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax           # R[%eax] = M[R[%rsp] + 8]
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)       
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax               # case 0 (based on jump table)
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>    # R[%eax] = 207
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax           # the input should equal R[%eax]
...
0000000000400fce <func4>:
  ...
  400fd4:	29 f0                	sub    %esi,%eax            # R[%eax] -= R[%esi]
  400fd6:	89 c1                	mov    %eax,%ecx            # R[%ecx] = R[%eax]
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx           # R[%ecx] >>= 31 ( sign bit ? )
  400fdb:	01 c8                	add    %ecx,%eax            # R[%eax] += R[%ecx] 
  400fdd:	d1 f8                	sar    %eax                 # R[%eax] >>= 1
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx   # R[%ecx] = R[%rsi] + R[%rax]
  400fe2:	39 f9                	cmp    %edi,%ecx            # R[%edi] ? R[%ecx]
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>  # R[%edi] >= R[%ecx]
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx      # R[%edx] = R[%rcx] - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>       
  400fee:	01 c0                	add    %eax,%eax            # R[%eax] <<= 1
  400ff0:	eb 15                	jmp    401007 <func4+0x39>  # 
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax
  400ff7:	39 f9                	cmp    %edi,%ecx
  400ff9:	7d 0c                	jge    401007 <func4+0x39>  # R[%ecx] >= R[%edi]
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi       # R[%esi] = R[%rcx] + 1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax    # R[%eax] = R[%rax] * 2 + 1
